    ...
    if (cmdID == CMD_SPEEDSTEALTH) then 
      ...
      Spring.Echo("cmdparams[1]=" .. tostring(cmdParams[1]))
        if cmdParams[1] == 1 then 
       			...
       			Spring.SetUnitCloak(unitID, true, 2 [125])      
        
      elseif cmdParams[1] == 2 then 
        		SetGroundMoveTypeData(unitID, maxVelocity=stealthspeedlist[unitID].orgspeed)
        		Spring.SetUnitCloak(unitID, true | 2, [ 250 | true]) 
